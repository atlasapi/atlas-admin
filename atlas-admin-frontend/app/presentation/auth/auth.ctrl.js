...
angular
  .module('atlasAdmin.auth')
  .controller('CtrlAuth', CtrlAuth);

function CtrlAuth($scope, $rootScope, $routeParams, $location, Authentication, Atlas, $log, Users) {
  ...
  Atlas
    .getAccessToken(oauth_token, oauth_verifier, code)
