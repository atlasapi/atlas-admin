...
var app = angular
  ...
  .controller('CtrlWishlistFeatures', CtrlWishlistFeatures);

CtrlWishlistFeatures.$inject = ['$scope', '$rootScope', '$routeParams', 'Wishes', '$q', '$uibModal'];

function CtrlWishlistFeatures($scope, $rootScope, $routeParams, Wishes, $q, $uibModal) {
  var root = $rootScope;
...
app
  .directive('featureRow', ['$document', function($document) {
    var template =
