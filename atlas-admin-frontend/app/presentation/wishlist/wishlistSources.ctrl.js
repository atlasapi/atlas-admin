...
var app = angular
  ...
  .controller('CtrlWishlistSources', CtrlWishlistSources);

CtrlWishlistSources.$inject = ['$scope', '$rootScope', '$routeParams', 'Wishes', '$q'];

function CtrlWishlistSources($scope, $rootScope, $routeParams, Wishes, $q) {
  var root = $rootScope;
