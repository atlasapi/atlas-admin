...
angular
  .module('atlasAdmin.interceptors.loading')
  .factory('LoadingInterceptor', LoadingInterceptor);

LoadingInterceptor.$inject = ['$q', '$rootScope', '$injector', '$timeout', '$location'];

function LoadingInterceptor($q, $rootScope, $injector, $timeout, $location) {
  var requests = 0;
  var loadTimer;
