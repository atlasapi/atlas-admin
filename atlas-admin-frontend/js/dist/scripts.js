...
app.factory('AuthenticationInterceptor', ['$q', '$location', 'atlasHost', 'atlasApiHost', '$window', 'Authentication', function($q, $location, atlasHost, atlasApiHost, $window, Auth) {
  return {
...
app.controller('UserMenuController', ['$scope', 'Users', '$rootScope', 'Authentication', '$location', 'GroupsService', '$q', 'userUrl', function($scope, Users, $rootScope, Authentication, $location, Groups, $q, userUrl) {
  var privateItems;
...
angular.module('atlasAdmin.controllers.applications').controller('CreateApplicationFormModalCtrl', ['$scope', '$q', '$sce', '$modalInstance', 'Applications', 'sourceRequests', 'SourceLicenses', '$location', function($scope, $q, $sce, $modalInstance, Applications, SourceRequests, SourceLicenses, $location) {
