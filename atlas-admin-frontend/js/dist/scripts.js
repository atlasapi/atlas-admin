...
angular.module('atlasAdmin.controllers.applications')
.controller('CtrlApplicationEdit', 'APIUsage', ['$scope', '$rootScope', '$routeParams', 'Applications', 'Sources', 'SourceLicenses', '$modal', '$sce', '$log', 
    function($scope, $rootScope, $routeParams, Applications, Sources, SourceLicenses, $modal, $sce, $log, Usage) {
    ...
    // API usage stuff
    $scope.apiKey = '6c3c613f3d1e496aaf7b597863dc820a';
